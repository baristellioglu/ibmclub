    ...
    <div class="site-menubar">
      <div class="site-menubar-body">
        <div>
          <div>
            <ul class="site-menu">
              <li class="site-menu-category">Membership Management</li>
               ...
               <ul class="site-menu-sub">
                <li class="site-menu-item">
                  <a class="animsition-link" href="#" data-slug="dashboard-v1">
                    ...
                    <span class="site-menu-title">List Members</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="#" data-slug="dashboard-v1">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">Create Members</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="#" data-slug="dashboard-v2">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">Update Members</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="#" data-slug="dashboard-v2">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">Delete Members</span>
                  </a>
                </li>
              </ul>
            </li>

            <li class="site-menu-category">Event Management</li>
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item">
                  <a class="animsition-link" href="#" data-slug="uikit-buttons">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">View Event List</span>
                  </a>
                </li>
                
                <li class="site-menu-item active">
                  <a class="animsition-link" href="#" data-slug="uikit-colors">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                ...
                <li class="site-menu-item">
                  <a class="animsition-link" href="uikit/dropdowns.html" data-slug="uikit-dropdowns">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">Update Event</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="uikit/list.html" data-slug="uikit-list">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">Delete Event</span>
                  </a>
                </li>
                    ...
                    <div class="col-md-12 col-sm-6 col-xs-12">
                      <div class="panel panel-default">
                       ...
                       <div class="panel-body padding-30">
                        <?php echo form_open('create_event/create_event'); ?>
                        <!--Event Name -->
                        <div class="form-group">
                          <label label-default="" class="col-md-2 control-label label-default">Event Name:</label>
                          <div class="col-md-10">
                        ...
                        <!--Event Date -->
                        <div class="form-group">
                          <label label-default="" class="col-md-2 control-label label-default">Event Date:</label>
                          <div class="col-md-10"> 
                           <input class="form-control" id="event_date" name="event_date" placeholder="MM/DD/YYYY" type="text"/>
                         </div>
                       </div>

                       <!--Event Place -->
                       <div class="form-group">
                        <label label-default="" class="col-md-2 control-label label-default">Event Place:</label>
                        <div class="col-md-10">
                      ...
                      <!--Event Quota -->
                      <div class="form-group">
                        <label label-default="" class="col-md-2 control-label label-default">Event Quota:</label>
                        <div class="col-md-10">
                          <input type="text" name="event_quota" class="form-control">
                        </div>
                      </div>

                      <!--Event Point -->
                      <div class="form-group">
                        <label label-default="" class="col-md-2 control-label label-default">Event Point:</label>
                        <div class="col-md-10">
                          <input type="text" name="event_point" class="form-control">
                        </div>
                      </div>

                      <!--Event Description -->
                      <div class="form-group">
                        <label label-default="" class="col-md-2 control-label label-default">Event Description:</label>
                        <div class="col-md-10">
...
<footer class="site-footer">
  <span class="site-footer-legal">© 2015</span>
