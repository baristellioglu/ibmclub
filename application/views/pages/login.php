...
<head>
  ...
  <body class="page-login layout-full">
    ...
    <div class="page-content vertical-align-middle">
      ...
      <p>IBM CLUB APP'e Giriş Yapınız</p>
      <?php echo form_open('pages/login'); ?>
      <div class="form-group">
        <label class="sr-only" for="member_id">IBM ID:</label>
        <input type="text" class="form-control" id="member_id" name="member_id" placeholder="IBM ID">
      </div>
    ...
    <p>Bugün IBM CLUB'a katıl. Hemen <a href="pages/register">Kayıt ol!</a></p>
